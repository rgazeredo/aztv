...
import { Plus, AlertTriangle, Monitor } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex items-center justify-between space-y-2">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Configure um novo player para sua rede
                    </p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Preencha os dados básicos do novo player
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <Alert>
                            ...
                            <AlertDescription>
                                <strong>Informações importantes:</strong> Após criar o player, será gerado um token único para a conexão.
                                Este token será necessário para configurar o aplicativo no dispositivo.
                            </AlertDescription>
                        </Alert>
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            >
                                ...
                                {processing ? 'Criando...' : 'Criar Player'}
                            </Button>
                        </div>
                    </form>
                </CardContent>
